...
import { Digi2 } from '../../../views/seminarios/digi2';
import { SeminariosService } from '../../../views/seminarios/seminarios.service';

@Component({
  selector: 'adra-seminarios-tabla',
  templateUrl: './seminarios-tabla.component.html',
  styleUrls: ['./st.css']
})
export class SeminariosTablaComponent implements OnInit {
